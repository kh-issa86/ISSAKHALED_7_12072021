...
// gets all the infos that will appear on the posts (ie : name of the poster, avatar, content, etc...)
Post.getAll = (result) => {
    sql.query(
...
Post.createPost = (newPost, result) => {
    // insert the new post in the posts table
...
//     //the query to changes sets the adminApproved column to 1 (true) in the right post
